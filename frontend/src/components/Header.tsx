  ...
  return (
    <header className="h-16 bg-white rounded-2xl flex items-center justify-between px-4 md:px-6 shadow-sm shrink-0">
      <div className="flex items-center gap-2 md:gap-3">
        <button className="bg-transparent border-none cursor-pointer flex items-center justify-center text-gray-500 p-2 rounded-full hover:bg-gray-100 hover:text-gray-900 transition-colors -ml-2">
      ...
      <div className="flex items-center gap-3 md:gap-5">
        <button className="relative text-gray-900 cursor-pointer bg-transparent border-none p-1">
          <span className="material-symbols-rounded">notifications</span>
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full border-2 border-white"></span>
        </button>
        <div className="flex items-center gap-2 bg-white px-1 py-1 md:pr-2 rounded-full cursor-pointer hover:bg-gray-50 transition-colors border border-gray-200">
          <Image src="/Component 1.png" alt="User Avatar" width={28} height={28} className="rounded-full object-cover bg-gray-100" />
