...
export default function DocumentWrapper({ children, aiMessage }: { children: React.ReactNode, aiMessage: string }) {
  return (
    <div className="flex-1 w-full max-w-5xl mx-auto px-4 md:px-6 pb-24 overflow-y-auto no-scrollbar">
      <div className="bg-[#333333] rounded-[32px] p-6 md:p-8 w-full shadow-lg relative min-h-[800px]">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <button className="bg-white text-gray-900 rounded-full px-5 py-2.5 text-[13px] font-bold flex items-center gap-2 shrink-0 hover:bg-gray-100 transition-colors shadow-sm cursor-pointer border-none">
